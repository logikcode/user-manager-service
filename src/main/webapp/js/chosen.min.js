/* Custom */
!function(s){s(document).ready(function(){e.init()}),jQuery(window).on("load",function(){jQuery("#accion_preloader_box").fadeOut(),jQuery("#accion_preloader_wrapper").delay(350).fadeOut("slow")}),s(window).scroll(function(){window.innerWidth;0==o&&(100<s(this).scrollTop()?s(".accion_cookies_div").show():s(".accion_cookies_div").hide())})}(jQuery);
